...
export class HomeComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.friendService.getFriends(this.currentUser._id).then((friends)=>{//console.log("friends result :",friends);
                                                                        ...
                                                                        var Ids=[];
                                                                        this.friends.forEach(function(friend){console.log("=",friend._id);Ids.push(friend._id)});
                                                                        this.friendsIds=Ids;
                                                                        console.log("ids",this.friendsIds);
                                                                        //get my friends's orders

                                                                        this.homeService.getFriendsOrders(this.friendsIds).then((orders)=>{console.log("friends result :",orders);
